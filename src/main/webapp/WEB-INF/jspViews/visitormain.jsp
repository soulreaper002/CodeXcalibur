						...
						<td width="100%">
							<table align="right" cellpadding="2">
								<tr>
									...
									<td width="160">
										<div id="menu" align="center">
											<a href="<jstlcore:url value="changePWD.html?uName=${visitor.userName}"/>">
												Change_Password </a>
										</div>
									</td>
									<td width="160">
										...
										<div id="content" align="center">
											<p class="content">
												<strong>To release a ticket you have for an
													up-coming attraction, please find the attraction below, and
													click the Release link.</strong>
											</p>
											<table width="96%" border="1" align="center">
												...
												<jstlcore:forEach items="${regEvents}" var="regEvent">
													<tr align="center">
														<td><jstlcore:out
																value="${fn:substring(visitor.lastName,0,4)}${fn:substring(visitor.firstName,0,3)}-${regEvent.signupid}"></jstlcore:out></td>
														...
														<td width="100px" bgcolor="#CCCC99"><a
															href="<jstlcore:url value="/eventunreg.htm?eventId=${regEvent.eventid}"/>">Release</a>
								...
								<jstlcore:choose>
									<jstlcore:when test="${event.seatsavailable != 0}">
										<td width="100px" bgcolor="#CCCC99" align="center"><jstlcore:out
												...
												seats left.</strong> <a
											href="<jstlcore:url value="/eventreg.htm?eventId=${event.eventid}"/>">Register</a>
										</td>
									</jstlcore:when>
									<jstlcore:otherwise>
